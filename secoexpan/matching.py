...
type_map = {'application': 'Application',
			...
			'programming_language': 'Promgramming_Language',
...
if __name__ == '__main__':
	...
	dictionary = {}
	with open(os.path.join(args.seeds_dir, f'seeds_secoexpan_{args.target}.txt')) as f:
		for line in f:
